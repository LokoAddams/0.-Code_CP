...
ll binnary_pow(ll b, ll n)
{
  ...
  if(n&1)
  {
    x_medio =  binnary_pow(b, (n-1)/2);
    x_medio %= m;
    return b%m * x_medio * x_medio;
  }
  else
  {
    x_medio =  binnary_pow(b, n/2);
    x_medio %= m;
    return x_medio * x_medio;
  }
